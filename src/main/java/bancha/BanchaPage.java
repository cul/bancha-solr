...
/**
  ...
  public class BanchaPage
  {
    ...
    public void setBaseName(String newBaseName) { baseName = newBaseName; }
    public String getBaseName() { return baseName; }

    public void setTitle(String newTitle) { title = newTitle; }
    public String getTitle() { return title; }

    public void setTitleSort(String newTitleSort) { title_sort = newTitleSort; }
    public String getTitleSort() { return title_sort; }

    public void setAuthor(String newAuthor) { author = newAuthor; }
    public String getAuthor() { return author; }

    public void setPageId(String newPageId) { pageId = newPageId; }
    public String getPageId() { return pageId; }

    public void setPageNum(String newPageNum) { pageNum = newPageNum; }
    public String getPageNum() { return pageNum; }

    public void setImprint(String newImprint) { imprint = newImprint; }
    public String getImprint() { return imprint; }

    public void setUrlLabel(String newUrlLabel) { url_label = newUrlLabel; }
